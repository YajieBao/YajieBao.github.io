...
Conditional distribution of multivariate normal distribution is very important, which leads a explanation of linear regression. And the rest part of this blog will focus on the conditional distribution. Let $X$ be a $p-$dimensional Multivariate normal distribution satisfies that
$$
...
$$
 ...
 $$
And this property is the basic of the Gaussian graphical model. $\{X_1,...,X_p\}$ are some vertices, $X_i$ and $X_j$ will be connected by an edge if 
$$
